...
Name of the algorithm: Boruvka's Algorithm

Time Complexity: O(E log V)

Pros: Boruvka’s algorithm is used as a step in a faster randomized algorithm that works in linear time O(E).
